...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:400italic,400,300,700&subset=vietnamese' rel='stylesheet'
        type='text/css'>
    <link type="text/css" rel="stylesheet" href="http://fonts.googleapis.com/css?family=Oswald:400,700,300">
    {{-- <link type="text/css" rel="stylesheet"
        href="{{ url('vendors/jquery-ui-1.10.3.custom/css/ui-lightness/jquery-ui-1.10.3.custom.css') }}"> --}}
...
<body id="error-page" class="animated bounceInLeft">
    <div id="error-page-content">
        ...
        <h3>
            <p>
                @if (isset($furl))
                    <a href='{{ url($furl) }}'>Bấm vào đây</a> để quay lại.
                @else
                    <button class="btn btn-info" onclick="window.history.back()">Quay lại</button>
                @endif
            </p>
        </h3>
    </div>
