                                    ...
                                    <tr class="{{ getTextStatus($value['trangthai']) }}">
                                        ...
                                        <td>
                                            @if ($value['mathdv'] != null)
                                                <a href="{{ url($furl . 'tonghop?thang=' . $value['thang'] . '&nam=' . $nam) }}"
                                                ...
                                                <a href="{{ url('/chuc_nang/xem_du_lieu/index?thang=' . $value['thang'] . '&nam=' . $nam . '&trangthai=ALL' . '&phanloai=ALL') }}"
                                                    class="btn btn-default btn-xs">
                                                    <i class="fa fa-list-alt"></i>&nbsp; Số liệu chi tiết</a>

                                                {{-- @if (in_array($value['trangthai'], ['TRALAI', 'CHUAGUI'])) --}}
                                                    ...
                                                    @endif
                                                    @if ($value['sldv'] == $value['dvgui'] && in_array($value['trangthai'], ['TRALAI', 'CHUAGUI']))
                                                ...
                                                @if ($value['trangthai'] != 'CHUADL')
                                                    ...
                                                    @if ($value['trangthai'] != 'CHUADAYDU')
                                                        ...
                                                        <button type="button" class="btn btn-default btn-xs"
                                                            ...
                                                            Gửi dữ liệu</button>
                                                    @else
                                                        <a href="{{ url('/chuc_nang/xem_du_lieu/index?thang=' . $value['thang'] . '&nam=' . $nam . '&trangthai=CHOGUI' . '&phanloai=ALL') }}"
                                                            class="btn btn-default btn-xs">
