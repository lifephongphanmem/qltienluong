        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <b>DỮ LIỆU TỔNG HỢP CHI TRẢ LƯƠNG TẠI ĐƠN VỊ CẤP DƯỚI THÁNG {{$model_thongtin->thang}} NĂM {{$model_thongtin->nam}}</b>
                ...
                <div class="row">
                    <div class="col-md-offset-5 col-md-2">
                        <a href="{{url('/chuc_nang/tong_hop_luong/huyen/index?nam='.date('Y'))}}" class="btn btn-default"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
                    </div>
                </div>
            </div>
        </div>
