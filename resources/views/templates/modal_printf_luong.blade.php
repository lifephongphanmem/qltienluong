...
<!--Mẫu TT107 -->
{!! Form::open(['url'=>(isset($furl)?$furl : '').'mautt107','method'=>'post' ,'target'=>'_blank', 'files'=>true, 'id' => 'printf_mautt107_m2']) !!}
<div id="mautt107_m2-modal" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
    <div class="modal-dialog modal-content">
            ...
            <div class="form-horizontal">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        {!!Form::select('lamtron',['0'=>'0','-1'=>'1','-2'=>'2','-3'=>'3',], '-2', array('id' => 'lamtron','class' => 'form-control select2me'))!!}
                    </div>
        ...
        <div class="modal-footer">
            <button type="button" data-dismiss="modal" class="btn btn-default">Hủy thao tác</button>
            <button type="submit" class="btn btn-primary" onclick="ClickBCtt107_m2_excel()" id="btn_xls">Xuất Excel</button>
