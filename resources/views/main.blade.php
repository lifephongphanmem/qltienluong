                ...
                @if(session('admin')->phanloaitaikhoan == 'SD')
                    @if(session('admin')->tinh == 'LAICHAU')
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="javascript:;">
                                        <i class="fa fa-folder-open-o"></i> Quản lý cán bộ <span class="arrow"></span>
                                    </a>
                    ...
                    @else
                        <li >
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="{{url('nghiep_vu/ho_so/danh_sach')}}"><i class="fa fa-caret-right"></i>Danh sách cán bộ đang công tác</a>
                                </li>
                                <li>
                                    <a href="{{url('nghiep_vu/tam_ngung/danh_sach')}}"><i class="fa fa-caret-right"></i>Danh sách cán bộ tạm ngừng theo dõi</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{url('nghiep_vu/truc/danh_sach?thang='.date('m').'&nam='.date('Y'))}}"><i class="fa fa-caret-right"></i>Danh sách cán bộ hưởng phụ cấp độc hại</a>
                                </li>
                                <li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            @if(session('admin')->phamvitonghop == 'HUYEN')
                                <li>
                                    <a href="{{url('nghiep_vu/ho_so/danh_sach_th?sunghiep=ALL&madv=ALL')}}"><i class="fa fa-caret-right"></i>Danh sách cán bộ</a>
                                </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            @if(session('admin')->level == 'H' && session('admin')->phamvitonghop == 'KHOI')
                                ...
                                <li>
                                    <a href="{{url('chuc_nang/xem_du_lieu/nguon/khoi?sohieu=TT67_2017&trangthai=ALL&phanloai=ALL')}}"><i class="fa fa-caret-right"></i>Xem số liệu tổng hợp từ đơn vị cấp dưới</a>
                                </li>
                            @endif

                            @if(session('admin')->level == 'H' && session('admin')->phamvitonghop == 'HUYEN')
                                    <li>
                                        <a href="{{url('nguon_kinh_phi/huyen/danh_sach')}}"><i class="fa fa-caret-right"></i>Số liệu nguồn kinh phí</a>
                                    </li>
                                <li>
                                    <a href="{{url('chuc_nang/tong_hop_nguon/huyen/index')}}"><i class="fa fa-caret-right"></i>Tổng số liệu nhu cầu kinh phí</a>
                                </li>
                                    <li>
                                        <a href="{{url('chuc_nang/xem_du_lieu/nguon/huyen?sohieu=TT67_2017&trangthai=ALL&phanloai=ALL')}}"><i class="fa fa-caret-right"></i>Xem số liệu tổng hợp từ đơn vị cấp dưới</a>
                                    </li>
                            @endif
