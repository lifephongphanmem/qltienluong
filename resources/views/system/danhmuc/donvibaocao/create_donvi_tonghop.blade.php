...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin đơn vị thêm mới <small>đơn vị tổng hợp</small>
    </h3>
    <!-- END PAGE HEADER-->
                    ...
                    <input type="hidden" name="phanloaitaikhoan" id="phanloaitaikhoan" value="{{$inputs['phan_loai']}}" />
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">Phạm vi tổng hợp</label>
                                        {!!Form::select('phamvitonghop', $a_phamvi, null, array('id' => 'phamvitonghop','class' => 'form-control'))!!}
                                    </div>
                                </div>
