                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-solid">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="{{url('/nghiep_vu/ho_so/nhan_excel')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-print"></i>Nhận từ file Excel</a>
                                </li>
                        ...
                        @foreach($model as $hs)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('/nghiep_vu/ho_so/inhoso?maso='.$hs->macanbo.'')}}" class="btn btn-default btn-xs mbs" target="_blank"><i class="fa fa-print"></i>&nbsp; In hồ sơ</a>
