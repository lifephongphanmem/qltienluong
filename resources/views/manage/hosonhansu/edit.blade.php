        ...
        <div class="col-md-12">
            <div class="portlet box blue" id="form_wizard_1">
                ...
                <div class="portlet-body form" id="form_wizard">
                    {!! Form::model($model, ['url'=>'/nghiep_vu/nhan_su/update/'.$model->id, 'method' => 'PATCH', 'files'=>true, 'id' => 'create-hscb', 'class'=>'horizontal-form form-validate', 'enctype'=>'multipart/form-data']) !!}
                    ...
                    <div class="form-body">
                        <ul class="nav nav-pills nav-justified steps">
                            ...
                            <li><a href="#tab5" data-toggle="tab" class="step">
                                    <p class="description"><i class="glyphicon glyphicon-list-alt"></i> Thông tin tuyển dụng</p></a>
                            </li>

                            <li><a href="#tab6" data-toggle="tab" class="step">
                                    <p class="description"><i class="glyphicon glyphicon-plus-sign"></i></i> Trình độ cán bộ</p></a>
                            </li>
                            ...
                            <li><a href="#tab7" data-toggle="tab" class="step">
                                    <p class="description"> <i class="glyphicon glyphicon-paperclip"></i> Thông tin khác</p></a>
                            </li>
                            <li><a href="#tab4" data-toggle="tab" class="step">
                                    <p class="description"><i class="glyphicon glyphicon-paperclip"></i> Chức vụ kiêm nhiệm</p></a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            @include('manage.hosonhansu.include.coban')
                            @include('manage.hosonhansu.include.baohiem')
                            @include('manage.hosonhansu.include.luong')
                            @include('manage.hosonhansu.include.kiemnhiem')
                            @include('manage.hosonhansu.include.tuyendung')
                            @include('manage.hosonhansu.include.trinhdo')
                            @include('manage.hosonhansu.include.khac')
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-4 col-md-8">
                                ...
                                <a href="{{url('/nghiep_vu/nhan_su/danh_sach')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}
