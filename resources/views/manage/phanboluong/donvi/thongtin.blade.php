            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption text-uppercase">
                        THÔNG TIN PHÂN BỔ LƯƠNG
                    </div>
                    <div class="actions"></div>
                </div>
                <div class="portlet-body">
                    {!! Form::open([
                        'url' => '/phanboluong/donvi/store',
                        'method' => 'POST',
                        'files' => true,
                        'id' => 'create-hscb',
                    ...
                    <div style="text-align: center;">
                        <button type="submit" class="btn btn-default">Tạo phân bổ <i
                                class="fa fa-save mlx"></i></button>
                        <a href="{{ url('/phanboluong/donvi') }}" class="btn btn-default"><i
