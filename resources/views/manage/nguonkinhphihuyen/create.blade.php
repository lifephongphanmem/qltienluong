            ...
            <div class="col-md-12">
                <div class="portlet box blue" id="form_wizard_1">
                    ...
                    <div class="portlet-body form" id="form_wizard">
                        {!! Form::open(['url'=>'/nguon_kinh_phi/huyen/store','method'=>'post' , 'files'=>true, 'id' => 'create_nkp','class'=>'horizontal-form form-validate']) !!}
                            <div class="form-body">
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-4 col-md-8">
                                        ...
                                        <button type="submit" class="btn btn-success">Tạo dữ liệu</button>
