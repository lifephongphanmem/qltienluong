...
@section('content')
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-list-alt"></i>DANH SÁCH HỒ SƠ CÁN BỘ NGHỈ HƯU - {{$tendv}}
                    </div>
                    <div class="actions">
    ...
    <div id="danhsach-modal" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        {!! Form::open(['url'=>'/nghiep_vu/ho_so/danh_sach_nghi_huu','method'=>'post' , 'files'=>true, 'id' => 'innangluong','target'=>'_blank']) !!}
    ...
    <script>
        ...
        function getLink(){
            var madv = $('#madv').val();
            return '/nghiep_vu/ho_so/nghi_huu_th?madv=' + madv;
        }
