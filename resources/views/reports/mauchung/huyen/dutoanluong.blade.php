...
<p id="data_body" style="text-align: center; font-weight: bold; font-size: 20px;">BÁO CÁO TỔNG HỢP DỰ TOÁN TIỀN LƯƠNG NĂM {{$thongtin['namns']}} CỦA ĐỊA BÀN {{getTenDB($thongtin['madvbc'])}}</p>
