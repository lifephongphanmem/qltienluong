...
@section('content')">
    ...
    <?php $a_hs = array(); ?>
    <table id="data_body" class="money" cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;font:normal {{$inputs['cochu']}}px Times, serif;">
        <thead>
        ...
        @foreach($a_congtac as $key=>$val)
            ...
            @if(count($model_luong)> 0)
                <tr style="font-weight: bold;">
                    ...
                    <td style="text-align: left;" colspan="{{19 + $col}}">{{$val}}</td>
                </tr>
    ...
    <table id="data_footer" class="header" width="96%" border="0" cellspacing="0" cellpadding="8" style="margin:20px auto; text-align: center;">
        <tr>
            ...
            <td style="text-align: center; font-style: italic" width="45%">{{$m_dv->diadanh .', ngày ... tháng ... năm ...'}}</td>
        </tr>
        <tr style="font-weight: bold">
