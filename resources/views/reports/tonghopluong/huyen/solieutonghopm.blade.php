...
@section('content')
    ...
    <table id="data_body3" cellspacing="0" cellpadding="0" border="1"
            ...
            @foreach ($a_tonghop as $th)
                ...
                <tr style="font-weight: bold;">
                    ...
                    <td style="text-align: left;" colspan="22">
                        {{ $th['tonghop'] == 'BANGLUONG' ? 'Số liệu chi trả lương' : 'Số liệu truy lĩnh lương' }}</td>
                </tr>
                @foreach ($chitiet as $ct)
                    <tr class="money">
                        ...
                        {{-- @if (in_array($ct->mact, ['1689729806', '1506673585']))
                        ...
                        @else --}}
                            ...
                            <td>{{ dinhdangsothapphan($ct->tongbh,5) }}</td>
                        {{-- @endif --}}
                ...
                <tr class="money" style="font-weight: bold">
                    ...
                    <td>{{ dinhdangsothapphan($chitiet->sum('stbhxh_dv'),5) }}</td>
                    <td>{{ dinhdangsothapphan($chitiet->sum('stbhyt_dv'),5) }}</td>
                    <td>{{ dinhdangsothapphan($chitiet->sum('stkpcd_dv'),5) }}</td>
                    <td>{{ dinhdangsothapphan($chitiet->sum('stbhtn_dv'),5) }}</td>
        ...
        <tr class="money" style="font-weight: bold">
            ...
            <td>{{ dinhdangsothapphan($model->sum('stbhxh_dv'),5) }}</td>
            <td>{{ dinhdangsothapphan($model->sum('stbhyt_dv'),5) }}</td>
            <td>{{ dinhdangsothapphan($model->sum('stkpcd_dv'),5) }}</td>
            <td>{{ dinhdangsothapphan($model->sum('stbhtn_dv'),5) }}</td>
