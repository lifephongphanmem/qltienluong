    ...
    <table id="data_body" class="money" cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;font:normal 12px Times, serif;">
        ...
        @foreach($a_tonghop as $th)
            ...
            <tr style="font-weight: bold;">
                ...
                <td style="text-align: left;" colspan="13">{{$th['tonghop']=='BANGLUONG'?'Số liệu chi trả lương':'Số liệu truy lĩnh lương'}}</td>
            </tr>
                ...
                @foreach($model_congtac as $congtac)
                    <?php
                        $model_luong = $model->where('mact',$congtac['mact'])
                                ->where('tonghop',$congtac['tonghop'])
                                ->where('manguonkp',$congtac['manguonkp']);
                    ?>
