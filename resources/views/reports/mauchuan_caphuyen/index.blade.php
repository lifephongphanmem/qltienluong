...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol>
                                ...
                                <!--li><a href="#" data-target="#thoaibcth-modal" data-toggle="modal" onclick="baocaoth('{{$furl.'BcSLCLCC_TT11'}}')">Báo cáo số lượng, chất lượng cán bộ, công chức huyện (Mẫu 01/TT11)</a></li-->
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    @include('reports.mauchuan_caphuyen.modal')
