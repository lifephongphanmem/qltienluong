...
<p style="text-align: center; font-weight: bold; font-size: 20px;">DANH SÁCH CÁN BỘ NHẬN TIỀN PHỤ CẤP ĐỘI CÔNG TÁC XÃ HỘI TÌNH NGUYỆN</p>
...
<table class="money" cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;">
    <tr style="padding-left: 2px;padding-right: 2px; text-align: center">
        ...
        <td style="width: 13%; text-align: center;font-weight: bold">Chức danh chính</td>
        <td style="width: 13%; text-align: center;font-weight: bold">Chức danh hưởng</br>phụ cấp</td>
        <td style="width: 10%; text-align: center;font-weight: bold">Mức lương</br>tối thiểu</td>
        <td style="text-align: center;font-weight: bold">Hệ số</td>
    ...
    @foreach($model as $ct)
        <tr>
            ...
            <td style="text-align: center">{{dinhdangsothapphan($ct->hesopc,5)}}</td>
    ...
    <tr style="font-weight: bold; text-align: center;">
        ...
        <td class="money" style="text-align: center">{{$model->sum('hesopc')}}</td>
