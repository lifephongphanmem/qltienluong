...
@section('content')
    ...
    <table id="data_body" class="money" cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;font:normal {{$thongtin['cochu']}}px Times, serif;">
            ...
            @if(count($a_luong)> 0)
                ...
                @foreach($a_luong as $luong)
                    <tr>
                        ...
                        <td style="text-align: left">{{isset($a_chucvu[$luong['macvcq']])?$a_chucvu[$luong['macvcq']]:''}}</td>
                ...
                @endforeach
                    ...
                    <tr style="font-weight: bold; text-align: center; font-style: italic">
                        ...
                        <td class="money">{{dinhdangso(array_sum(array_column($a_luong,'ttl')) + array_sum(array_column($a_luong,'ttl_tl')))}}</td>
        ...
        <tr style="font-weight: bold; text-align: center;">
            ...
            <td class="money">{{dinhdangso(array_sum(array_column($a_canbo,'ttl')) + array_sum(array_column($a_canbo,'ttl_tl')))}}</td>
