...
@section('content')
    ...
    <table id="data_header" class="header" width="96%" border="0" cellspacing="0" cellpadding="8"
        ...
        <tr>
            <td colspan="2">
                <b>TỔNG HỢP KINH PHÍ TĂNG THEO NGHỊ ĐỊNH SỐ 73/2024/NĐ-CP - NGƯỜI HOẠT ĐỘNG KHÔNG CHUYÊN TRÁCH Ở CẤP XÃ, Ở THÔN, TỔ DÂN PHỐ</b>
            </td>
        </tr>
        <tr>
            <td colspan="2">
    ...
    <table id="data_body" width="96%" border="1" cellspacing="0" cellpadding="4"
        ...
        <tr>
            ...
            <th style="width: 8%">KHOÁN QUỸ PHỤ CẤP 01 THÁNG THEO NGHỊ ĐỊNH 33 (LƯƠNG 1,8)</th>
            <th style="width: 8%">KHOÁN QUỸ PHỤ CẤP 01 THÁNG THEO NGHỊ ĐỊNH 73 (LƯƠNG 2,34)</th>
