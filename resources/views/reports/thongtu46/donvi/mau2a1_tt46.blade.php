...
@section('content')
    ...
    <table id="data_body3" cellspacing="0" cellpadding="0" border="1"
        style="margin: 20px auto;font-size: 11px; border-collapse: collapse;">
        <tr style="padding-left: 2px;padding-right: 2px">
            ...
            <th style="width: 6%;padding-left: 2px;padding-right: 2px" rowspan="3">BIÊN CHẾ ĐƯỢC</br>CẤP CÓ THẨM QUYỀN
                GIAO HOẶC PHÊ DUYỆT NĂM 2018</th>
            <th style="width: 6%;padding-left: 2px;padding-right: 2px" rowspan="3">TỔNG SỐ</br>ĐỐI TƯỢNG HƯỞNG LƯƠNG CÓ
                MẶT ĐẾN 01/07/2019</th>
            <th style="width: 6%;padding-left: 2px;padding-right: 2px" colspan="14">QUỸ LƯƠNG, PHỤ CẤP VÀ CÁC KHOẢN ĐÓP
                GÓP THÁNG 07/2019 THEO NGHỊ ĐỊNH SỐ 72/2018/NĐ-CP</th>
