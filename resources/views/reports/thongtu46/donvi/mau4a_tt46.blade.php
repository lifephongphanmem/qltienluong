...
<p style="text-align: center; font-weight: bold; font-size: 20px;">BÁO CÁO NGUỒN KINH PHÍ ĐỂ THỰC HIỆN CẢI CÁCH TIỀN LƯƠNG NĂM 2019</p>
...
<table cellspacing="0" cellpadding="0" border="1" style="margin: 10px auto; border-collapse: collapse;">
    ...
    <tr style="font-weight: bold;">
        ...
        <td class="money">{{dinhdangso($a_TC['BIII'])}}</td>
    </tr>
...
<table class="header" width="96%" border="0" cellspacing="0" cellpadding="8" style="margin:20px auto; text-align: center;">
    ...
    <tr style="font-weight: bold">
        ...
        <td style="text-align: center;text-transform: uppercase" width="50%">{{$m_dv->cdlanhdao}}</td>
    </tr>
