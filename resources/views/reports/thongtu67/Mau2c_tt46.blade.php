...
<table id="data_header" width="96%" border="0" cellspacing="0" cellpadding="4" style="margin:0 auto 20px;text-align: center">
    ...
    <tr>
        <td colspan="2">
            <b>BÁO CÁO NHU CẦU KINH PHÍ THỰC HIỆN BẢO HIỂM THẤT NGHIỆP THEO NGHỊ ĐỊNH 28/2015/NĐ-CP NĂM 2019</br> </b>
        </td>
    </tr>
    <tr>
        <td colspan="2">
...
<table id="data_body" width="96%" border ="1" cellspacing="0" cellpadding="4" style="margin:0 auto 20px; text-align: center;">
    <tr >
        ...
        <th colspan="2">QT thu BHTN 2018</th>
        <th rowspan="3">Biên chế được cấp có thẩm quyền giao hoặc phê duyệt năm 2019</th>
        <th rowspan="3">Tổng số đối tượng hưởng lương có mặt đến 01/07/2019 nộp BHTN</th>
        <th colspan="7">Tổng QL, phụ cấp và BH thất nghiệp tháng 7/2019 theo NĐ 72/2018/NĐ-CP</th>
        <th colspan="7">Tổng QL, phụ cấp và BH thất nghiệp tháng 7/2019 theo NĐ 38/2019/NĐ-CP</th>
        <th rowspan="3">Chênh lệch bảo hiểm thất nghiệp tăng thêm 1 tháng</th>
        <th rowspan="3">Nhu cầu thực hiện BHTN năm 2019</th>
    </tr>
    <tr >
...
<table id="data_footer" width="96%" border ="0" cellspacing="0" cellpadding="4" style="margin:0 auto 20px; text-align: center;">
    <tr>
        <td ></td>
