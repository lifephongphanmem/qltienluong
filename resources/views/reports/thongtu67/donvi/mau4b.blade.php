...
<p id="data_body" style="text-align: center; font-weight: bold; font-size: 20px;text-transform: uppercase">TỔNG HỢP NHU CẦU, NGUỒN THỰC HIỆN {{$model_thongtu->cancu}}</p>
<p id="data_body1" style="text-align: center; font-style: italic">(Ban hành kèm theo {{$model_thongtu->tenttqd}})</p>
