                ...
                @foreach ($a_dv as $madv => $tendv)
                    ...
                    @foreach ($m_donvi as $ct)
                        <tr style="text-align: center; font-style: italic">
                            ...
                            {{-- Chenh lệch --}}
                            <td style="text-align: right;">
                                {{ dinhdangso($ct->chenhlech01thang, 0, $inputs['donvitinh']) }}</td>
                            <td style="text-align: right;">
                                {{ dinhdangso($ct->chenhlech06thang, 0, $inputs['donvitinh']) }}</td>
                        ...
                        @foreach ($a_dv as $madv => $tendv)
                            ...
                            @foreach ($m_donvi_gd as $ct_gd)
                                <tr style="text-align: center; font-style: italic">
                                    ...
                                    {{-- Chenh lệch --}}
                                    <td style="text-align: right;">
                                        {{ dinhdangso($ct_gd->chenhlech01thang, 0, $inputs['donvitinh']) }}</td>
                                    <td style="text-align: right;">
                                        {{ dinhdangso($ct_gd->chenhlech06thang, 0, $inputs['donvitinh']) }}</td>
                                    <td style="text-align: right;">
                                        {{ dinhdangso($ct_gd->quythuong, 0, $inputs['donvitinh']) }}</td>
                                </tr>
                            @endforeach
                        @endforeach
                    @endif
            ...
            @foreach ($a_dv as $madv => $tendv)
                ...
                @foreach ($m_donvi as $ct)
                    <tr style="text-align: center; font-style: italic">
                        ...
                        <td>{{ dinhdangso($ct->ttbh_dv_moi, 0, $inputs['donvitinh']) }}</td>
                        {{-- Chenh lệch --}}
                        <td style="text-align: right;">{{ dinhdangso($ct->chenhlech01thang, 0, $inputs['donvitinh']) }}
                        </td>
                        <td style="text-align: right;">{{ dinhdangso($ct->chenhlech06thang, 0, $inputs['donvitinh']) }}
                        </td>
                        <td style="text-align: right;">{{ dinhdangso($ct->quythuong, 0, $inputs['donvitinh']) }}</td>
                    </tr>
                @endforeach
