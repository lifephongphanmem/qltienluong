...
@section('content')
    ...
    <table id="data_body3" cellspacing="0" cellpadding="0" border="1"
        ...
        <tr style="font-weight: bold;">
            ...
            <td class="text-right">{{ dinhdangso($a_TC['A'], 0, $inputs['donvitinh']) }}</td>
        </tr>
        ...
        <tr style="font-weight: bold;">
            ...
            <td class="text-right">{{ dinhdangso($a_TC['BI'], 0, $inputs['donvitinh']) }}</td>
        </tr>
        ...
        <tr style="font-weight: bold;">
            ...
            <td class="text-right">{{ dinhdangso($a_TC['BII'], 0, $inputs['donvitinh']) }}</td>
        </tr>
        ...
        <tr style="font-weight: bold;">
            ...
            <td class="text-right">{{ dinhdangso(abs($a_TC['A'] - $a_TC['BI'] - $a_TC['BII']), 0, $inputs['donvitinh']) }}
            </td>
        </tr>
        <tr>
            <td>1</td>
