    ...
    <table id="data_body3" cellspacing="0" cellpadding="0" border="1"
        ...
        @foreach ($model_donvi_bc as $diaban)
            ...
            <tr style="font-weight: bold;">
                ...
                <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['canbo_dutoan']) }}</td>
                <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['canbo_congtac']) }}</td>
                {{-- Mức lương cũ --}}
                <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['solieu']['tongcong'], 0, $inputs['donvitinh']) }}</td>
                <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['solieu']['st_heso'], 0, $inputs['donvitinh']) }}</td>
                <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['solieu']['st_tongpc'], 0, $inputs['donvitinh']) }}</td>
                @foreach ($a_phucap as $k => $v)
                    <?php $mapc = 'st_' . $k; ?>
                    <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['solieu'][$mapc], 0, $inputs['donvitinh']) }}</td>
                @endforeach
                <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['solieu']['ttbh_dv'], 0, $inputs['donvitinh']) }}</td>
                {{-- Mức lương mới --}}
                <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['solieu_moi']['tongcong']) }}</td>
                <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['solieu_moi']['st_heso']) }}</td>
                <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['solieu_moi']['st_tongpc']) }}</td>
                @foreach ($a_phucap as $k => $v)
                    <?php $mapc = 'st_' . $k; ?>
                    <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['solieu_moi'][$mapc], 0, $inputs['donvitinh']) }}</td>
                @endforeach
                <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['solieu_moi']['ttbh_dv'], 0, $inputs['donvitinh']) }}</td>
                {{-- Chênh lệch --}}
                <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['chenhlech01thang'], 0, $inputs['donvitinh']) }}</td>
                <td>{{ dinhdangso($a_Tong[$diaban->madvbc]['chenhlech06thang'], 0, $inputs['donvitinh']) }}</td>
            </tr>
            ...
            @foreach ($ar_II[$diaban->madvbc] as $dulieu)
                <tr>
            ...
            @foreach ($ar_III[$diaban->madvbc] as $dulieu)
                <tr style="text-align: center">
                    <td style="text-align: center;{{ $dulieu['style'] }}">{{ $dulieu['tt'] }}</td>
                    <td style="text-align: left;{{ $dulieu['style'] }}">{{ $dulieu['noidung'] }}</td>
                    <td style="{{ $dulieu['style'] }}">{{ dinhdangso($dulieu['canbo_dutoan']) }}</td>
            ...
            @foreach ($ar_IV[$diaban->madvbc] as $dulieu)
                <tr style="text-align: center">
                    <td style="text-align: center;{{ $dulieu['style'] }}">{{ $dulieu['tt'] }}</td>
                    <td style="text-align: left;{{ $dulieu['style'] }}">{{ $dulieu['noidung'] }}</td>
                    <td style="{{ $dulieu['style'] }}">{{ dinhdangso($dulieu['canbo_dutoan']) }}</td>
