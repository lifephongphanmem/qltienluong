...
class CreateTonghopluongTinhDiabanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tonghopluong_tinh_diaban', function (Blueprint $table) {
    ...
    {
        Schema::drop('tonghopluong_tinh_diaban');
    }
}
