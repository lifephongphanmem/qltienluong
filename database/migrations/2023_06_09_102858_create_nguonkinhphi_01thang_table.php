...
class CreateNguonkinhphi01thangTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        //làm bảng lấy thông tin 01 tháng để kết xuất mẫu 2a (là tháng đầu tiên trong kỳ thường là tháng 07)
        Schema::create('nguonkinhphi_01thang', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('nguonkinhphi_01thang');
    }
}
