...
class CreateTonghopluongKhoiChitietTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tonghopluong_khoi_chitiet', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('tonghopluong_khoi_chitiet');
    }
}
