...
class CreateBangluongdangkyPhucapTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bangluongdangky_phucap', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('bangluongdangky_phucap');
    }
}
