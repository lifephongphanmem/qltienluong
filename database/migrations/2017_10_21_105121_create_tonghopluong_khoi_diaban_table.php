...
class CreateTonghopluongKhoiDiabanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tonghopluong_khoi_diaban', function (Blueprint $table) {
    ...
    {
        Schema::drop('tonghopluong_khoi_diaban');
    }
}
