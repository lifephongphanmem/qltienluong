...
class CreateTonghopluongDonviDiabanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tonghopluong_donvi_diaban', function (Blueprint $table) {
    ...
    {
        Schema::drop('tonghopluong_donvi_diaban');
    }
}
