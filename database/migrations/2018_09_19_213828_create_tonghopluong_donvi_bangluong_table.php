...
class CreateTonghopluongDonviBangluongTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tonghopluong_donvi_bangluong', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('tonghopluong_donvi_bangluong');
    }
}
