...
class CreatePhanboluongBangluongTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('phanboluong_bangluong', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('phanboluong_bangluong');
    }
}
