...
class CreateTonghopluongTinhChitietTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tonghopluong_tinh_chitiet', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('tonghopluong_tinh_chitiet');
    }
}
