...
class CreatePhanboluongChitietTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('phanboluong_chitiet', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('phanboluong_chitiet');
    }
}
