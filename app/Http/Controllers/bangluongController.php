        ...
        if (Session::has('admin')) {
            ...
            if (count($model) > 0) {
                ...
                foreach ($model_canbo_tl as $cb) {
                    ...
                    $cb->tencanbo = $cb->tencanbo;

                    $cb->ttl = $inputs['luongcoban'] * $cb->hesott * $thang_tl;
                    $luongnopbaohiem = $inputs['luongcoban'] * $cb->hesott;
